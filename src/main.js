  ...
  document.getElementById('app').innerHTML = `
    <div class="app-layout">
      ...
      <div class="tabs-bar" id="tabs-bar">
        ${DATABASES.map(db => {
          let logoHtml = ''
          if (db.id === 'fpf') logoHtml = `<img src="${FPF_LOGO}" style="width:16px;height:16px;object-fit:contain;margin-right:6px;display:inline-block;vertical-align:-3px;" />`
          if (db.id === 'cbf') logoHtml = `<img src="${CBF_LOGO}" style="width:16px;height:16px;object-fit:contain;margin-right:6px;display:inline-block;vertical-align:-3px;" />`
